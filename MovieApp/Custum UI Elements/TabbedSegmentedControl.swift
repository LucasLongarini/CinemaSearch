//
//  TabbedSegmentedControl.swift
//  MovieApp
//
//  Created by Lucas Longarini on 2018-08-24.
...
class TabbedSegmentedControl: UIControl {
    ...
    var fontSize: Int = 14{
        didSet{
            selectedFont = selectedFont.withSize(CGFloat(fontSize + 2))
    ...
    @objc func buttonTapped(button: UIButton){
        for (index, btn) in buttons.enumerated(){
            ...
            if btn == button{
                //if already selected dont send an event
